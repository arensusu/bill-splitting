...
var file_proto_billSplitting_proto_rawDesc = []byte{
	...
	0x2f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x9a, 0x02, 0x0a,
	...
	0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x21, 0x5a, 0x1f, 0x67, 0x69, 0x74,
...
var file_proto_billSplitting_proto_goTypes = []interface{}{
	...
	(*CreateExpenseSummaryChartResponse)(nil), // 3: proto.CreateExpenseSummaryChartResponse
	(*GetAuthTokenResponse)(nil),              // 4: proto.GetAuthTokenResponse
	(*CreateLineGroupResponse)(nil),           // 5: proto.CreateLineGroupResponse
}
var file_proto_billSplitting_proto_depIdxs = []int32{
	...
	3, // 3: proto.BillSplitting.CreateExpenseSummaryChart:output_type -> proto.CreateExpenseSummaryChartResponse
	4, // 4: proto.BillSplitting.GetAuthToken:output_type -> proto.GetAuthTokenResponse
	5, // 5: proto.BillSplitting.CreateLineGroup:output_type -> proto.CreateLineGroupResponse
