...
func createRandomGroupMember(t *testing.T) db.GroupMember {
	...
	groupMember, err := testStore.CreateGroupMember(context.Background(), param)
...
func TestGetGroupMember(t *testing.T) {
	...
	groupMember2, err := testStore.GetGroupMember(context.Background(), param)
...
func TestDeleteGroupMember(t *testing.T) {
	...
	err := testStore.DeleteGroupMember(context.Background(), deleteParam)
	...
	groupMember2, err := testStore.GetGroupMember(context.Background(), getParam)
